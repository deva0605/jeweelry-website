 ...
 *  - checkoutLimiter : 5 requests / 15 min — applied only to POST /api/checkout
 *
...
/**
 * checkoutLimiter — applied to POST /api/checkout
 * 5 requests per 15-minute window per IP.
 * Prevents abuse: spam order creation, DOS attacks, etc.
 */
